...
def VISTDataloader(input_path, begin_idx, end_idx, max_text_length):
    with open(os.path.join(input_path, 'gill_data.json'), 'r') as f:
        data = json.load(f)
    ...
    for d in data:
        ...
        prompts[id].append("Q: What may happen next? Describe it to me in detail.\nA:")
